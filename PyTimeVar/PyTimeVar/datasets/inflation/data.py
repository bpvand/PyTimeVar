...
def load(start_date=None, end_date=None):
    """
    Load the inflation rate dataset and optionally filter by date range.
    This dataset contains the emissions data from 1947 to 2024.
    ...
    start_date : str, optional
        ...
        Format 'YYYY'. 
        Minimum start year is 1947.
    end_date : str, optional
        The end year to filter the data.
        Format 'YYYY'. 
        Maximum end year is 2024.
