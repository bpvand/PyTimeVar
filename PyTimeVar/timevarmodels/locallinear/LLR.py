...
class LocalLinearRegression:
    ...
    class Results:
      ...
      def summary(self):
          ...
          print("You can choose out of 5 types of Bootstrap to construct confidence bands:")
          print("SB (Sieve Bootstrap), WB (Wild Bootstrap), SWB (Sieve Wild Bootstrap), MB (Multiplier Bootstrap), LBWB (Local Blockwise Wild Bootstrap)")
          print("=" * 30)
